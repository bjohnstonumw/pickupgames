						...
						<div class="row">
							<div class="12u">
								...
								<!-- Main Content -->
									<section>
										<header>
											<h2>Example Job Application</h2>
											<h3>Avoids using a database for better portability.</h3>
										</header>
					
					
										
										<p>	<h2>Job Application</h2>
											<form method = "post" action = "example-form.php" enctype="multipart/form-data">
												...
												<table>
													...
													<tr><td>&nbsp;</td></tr>
													<tr><td>&nbsp;</td><td> <textarea name="resume" id="resume" rows=6 cols=80 >"Copy/Paste Resume Here." </textarea> </td></tr>
													
													<tr><td><input type="submit" name="submit" value="Submit Job Application" /></td><td>&nbsp;</td></tr>
										...
										<?php include "php/jobapp.php"; #This line includes the infor in jobapp.php as if it was copied here directly. ?>
